...
const DotGroup = ({ selectedPage, setSelectedPage }) => {
  const selectedStyles = `relative bg-[#03CEA4] before:absolute before:w-6 before:h-6 before:rounded-full
    before:border-2 before:border-[#03CEA4] before:left-[-50%] before:top-[-50%]`;
